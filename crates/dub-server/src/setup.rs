    ...
    vec![
        ...
        Component {
            ...
            files: &[
                ...
                FileSpec { url: "https://huggingface.co/cstr/cosyvoice3-0.5b-2512-GGUF/resolve/main/cosyvoice3-voices.gguf", dest_rel: "models/cosyvoice3/cosyvoice3-voices.gguf", size: 665_472, extract: Extract::None },
            ],
            markers: &[
                ...
                Marker { rel: "models/cosyvoice3/cosyvoice3-voices.gguf", expect: 0 },
            ],
        ...
        Component {
            ...
            size: 98_000_000,
            files: &[
                FileSpec { url: "https://github.com/CrispStrobe/CrispASR/releases/latest/download/crispasr-windows-x86_64-cuda.zip", dest_rel: "tools/crispasr/_crispasr.zip", size: 0, extract: Extract::ZipFlat },
            ],
